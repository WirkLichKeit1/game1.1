export class BootScene extends Phaser.Scene {
    ...
    preload() {
        ...
        this.add.rectangle(width / 2, height / 2, 300, 8, 0x1a3a28)
        bar.setDepth(1)
    ...
    _createPlaceholderGraphics() {
        ...
        for (const tx of treePositions) {
            ...
            trees.fillRect(tx + 14, BH - trunkH, 12, trunkH)
