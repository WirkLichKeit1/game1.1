export class Checkpoint extends Phaser.GameObjects.Container {
    constructor(scene, x, y) {
        ...
        // Hitbox de trigger (zona de ativação)
        this._zone = scene.add.zone(x, y - 10, 48, 80)
    ...
    _drawBase() {
        ...
        g.fillEllipse(0, 8, 36, 12)
        g.fillStyle(0x6a6a7a)
        g.fillEllipse(-10, 6, 14, 10)
        g.fillEllipse(10, 6, 14, 10)
        g.fillEllipse(0, 4, 12, 8)
    ...
    update(delta) {
        ...
        // Atualiza posição das partículas junto com o container
        this._sparks.setPosition(this.x, this.y - 8)
    }
